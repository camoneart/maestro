...
const ZSH_COMPLETION = [
  '#compdef scj shadow-clone-jutsu',
...
const FISH_COMPLETION = [
  '# shadow-clone-jutsu fish completion',
  '',
  '# コマンドの補完を無効化',
  'complete -c scj -e',
  ...
  '',
  '# list コマンドのオプション',
  'complete -c scj -n "__fish_seen_subcommand_from list ls" -s j -l json -d "JSON形式で出力"',
  'complete -c scj -n "__fish_seen_subcommand_from list ls" -l fzf -d "fzfで選択"',
  'complete -c scj -n "__fish_seen_subcommand_from list ls" -l filter -d "フィルタ"',
  'complete -c scj -n "__fish_seen_subcommand_from list ls" -l sort -d "ソート"',
  'complete -c scj -n "__fish_seen_subcommand_from list ls" -l last-commit -d "最終コミット情報を表示"',
  '',
  '# delete コマンドのオプション',
